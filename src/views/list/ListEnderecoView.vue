  ...
  <div class="view">
    <header class="header">
      ...
      <div class="header__items">
        ...
        <router-link to="/endereco/new" class="btn btn--contrast bg-secondary">
          {{ $t('app.add') }}
        </router-link>
      </div>
    </header>
...
@Component
export default class ListEnderecoView extends Mixins(MixinQueryRouter) {
  ...
  async downloadCsv() {
    ...
    new CsvEnderecoSchema().downloadCsv(csv.all())
  }
}
</script>
