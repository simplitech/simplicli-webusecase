  ...
  <div class="view">
    <header class="header">
      ...
      <div class="header__items">
        ...
        <await name="listTag" :spinnerScale="0.8" />
        ...
        <router-link to="/tag/new" class="btn btn--contrast bg-secondary">
          {{ $t('app.add') }}
        </router-link>
      </div>
    </header>
...
@Component
export default class ListTagView extends Mixins(MixinQueryRouter) {
  schema = new ListTagSchema()
  ...
  async downloadCsv() {
    ...
    new CsvTagSchema().downloadCsv(csv.all())
  }
}
</script>
