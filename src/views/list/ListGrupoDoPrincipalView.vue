  ...
  <div class="view">
    <header class="header">
      ...
      <div class="header__items">
        ...
        <await name="listGrupoDoPrincipal" :spinnerScale="0.8" class="w-12" />
      ...
      <transition-expand>
        <div v-show="filterOpen" class="z-10">
          <filter-grupo-do-principal :collection="collection" />
        </div>
      </transition-expand>
    </header>
...
import FilterGrupoDoPrincipal from '@/components/filters/FilterGrupoDoPrincipal.vue'
...
@Component({
  components: {FilterToggle, FilterGrupoDoPrincipal},
})
export default class ListGrupoDoPrincipalView extends Mixins(MixinRouteMatch) {
