  ...
  <div class="view">
    <header class="header">
      ...
      <div class="header__items">
        ...
        <await name="listItemDoPrincipal" :spinnerScale="0.8" class="w-12" />
      ...
      <transition-expand>
        <div v-show="filterOpen" class="z-10">
          <filter-item-do-principal :collection="collection" />
        </div>
      </transition-expand>
    </header>
...
import FilterItemDoPrincipal from '@/components/filters/FilterItemDoPrincipal.vue'
...
@Component({
  components: {FilterToggle, FilterItemDoPrincipal},
})
export default class ListItemDoPrincipalView extends Mixins(MixinRouteMatch) {
