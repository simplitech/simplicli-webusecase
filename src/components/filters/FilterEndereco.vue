<template>
  <div class="filter-endereco">
    <div class="filter-endereco__content">
...
import {FilterEnderecoSchema} from '@/schema/resource/Endereco/FilterEnderecoSchema'

@Component
export default class FilterEndereco extends Vue {
  @Prop({type: Object, required: true}) collection!: EnderecoCollection

  schema = new FilterEnderecoSchema()
